...
const Login = () => {
  ...
  return (
    <div class="flex  items-center justify-center min-h-screen bg-blue-300 ">
      ...
      >
        <div class="flex flex-col justify-center align-items-center p-8 md:p-14 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-md">
        <Toaster/>
          <span className="mb-3 text-4xl font-bold text-blue-600">🧑🏻‍🎓!Your Journey Begins!💥</span>
          ...
          <div class="py-4  justify-between">
            ...
            <input
              ...
              class="w-full p-2 border border-white hover:placeholder:text-black ouline-none hover:outline-none hover:bg-blue-200  rounded-md"
            ></input>
          ...
          <div class="py-4  justify-between">
            ...
            <input
              ...
              class=" w-full p-2 border border-white  rounded-md
                    ...
                    hover:text-black  hover:bg-blue-200  hover:outline-none ouline-none"
              onChange={handleChange}
            ></input>
          ...
          <div class="flex flex-col space-y-2">
            <button
              class="w-full bg-black text-white p-2 rounded-lg mt-5
                 font-bold font-serif hover:text-black hover:bg-blue-200"
            >
              Sign in
            </button>

            <span class="flex justify-center items-center">or</span>
            <button class=" flex gap-4 justify-center w-full bg-black  font-serif text-white font-bold p-2 rounded-lg hover:bg-blue-200  hover:text-black ">
              <FcGoogle class="mt-1" />
              Sign in with Google
            </button>
          </div>
